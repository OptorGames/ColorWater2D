...
namespace Assets.DevToDev.Analytics.Editor
{
    public static class DTDPostProcessAnalytics
    {
        ...
        private static void AddAnalyticsFramework(string projectPath, UnityEditor.iOS.Xcode.PBXProject project, string targetGuid,
        ...
        private static void DirectoryCopy(string sourceDirName, string destDirName, bool copySubDirs, params string[] specificExtensions)
        {
